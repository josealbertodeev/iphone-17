        ...
        <section className="bg-black py-20 px-6" id="design">
            <div className="max-w-7xl mx-auto text-center mb-12">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-400">Cada detalhe foi pensado para proporcionar uma experiência única.</p>
                </div>
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <ul className="space-y-3 text-gray-300">
                        ...
                        <li className="text-gray-400"> GPU 25% mais eficiente</li>
                        <li className="text-gray-400"> Neural Engine com 16 núcleos</li>
                        <li className="text-gray-400"> Ray tracing acelerado por hardware</li>
                    </ul>
                </div>
                ...
                <div className="text-center" id="camera" >
                    ...
                    <div className="grid grid-cols-3 gap-6 ">
                        <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 transition-transform duration-300 cursor-pointer">
                            <div className="text-4xl font-bold text-blue-600 mb-4">48 MP</div>
                            <h4 className="text-xl font-semibold mb-2">Principal</h4>
                            <p className="text-gray-400">Sensor maior para fotos mais nítidas e detalhadas.</p>
                        </div>

                        <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 transition-transform duration-300 cursor-pointer">
                            <div className="text-4xl font-bold text-orange-500 mb-4">12 MP</div>
                            <h4 className="text-xl font-semibold mb-2">Ultra Wide</h4>
                            <p className="text-gray-400">Campo de visão mais amplo para fotos panorâmicas.</p>
                        </div>

                        <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 transition-transform duration-300 cursor-pointer">
                            <div className="text-4xl font-bold text-blue-600 mb-4">12 MP</div>
                            <h4 className="text-xl font-semibold mb-2">Telefoto 5x</h4>
                            <p className="text-gray-400">Zoom óptico de 5x para detalhes impressionantes à distância.</p>
                        </div>
                    </div>
                </div>
            </div>
